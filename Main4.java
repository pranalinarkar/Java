...
public class Main4 {
	...
	public static void main(String[] args) {
		...
		try(Connection con=ConnectionUtil.getConnection(driver,url,user,pass)){
			...
			//st.execute("CREATE TABLE Card(id int primary key,expiry Date,customer_id int,balance float,credit_limit varchar(20))");
			//st.close();
			Customer c=new Customer(4,"Priyal","Narkar","pnarkar@gmail.com");
			Customer c2=new Customer(5,"Nikhil","Narkar","pnarkar@gmail.com");
